...
function initalSetUp() {
    ...
    timmer.append("Time Remaining: 60s");
...
function startTimer() {
       var getTime = setInterval(function () {
           timeRemaining--;
           timmer.empty();
           timmer.append("Time Remaining: " + timeRemaining + "s");
           ...
           if(timeRemaining == 0){
               ...
               let score = $('#timesUp');
               score.append("Your Speed: "+ calculateScore() + "WPM");
           }
       }, 1000);
